...
const steps = [
  ...
  ["Importing Excel files", "Open Imports and choose an .xlsx file. Put headings such as Teacher, Teacher Post, School, Centre Code and Block in the first row; columns can be in any order. Check each Save as choice and select a field for unfamiliar headings, or leave that column out. New schools need their block and coordinates. Save schools and blocks first, then check the Teacher review below and select Save changes. Blank cells keep saved details unchanged. For several sheets, import one sheet at a time. Teachers absent from the file are kept by default. If two teachers at the same school have the same name, add or edit them separately in Schools & teachers.", "/imports", "Open Imports"],
